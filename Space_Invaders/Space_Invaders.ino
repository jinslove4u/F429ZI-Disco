...
#define JPAD     PA2  // joypad
#define MISSILE  PA0  // missile  F429-disco default Button. 
#define PAUSE    PA4  // missile

#define counter 1000 //debounce time

#define nr_enemy 20  //초기 적숫자   4x5 
#define chance_shoot 4

unsigned int joyX; //Analog joystick x value
...
Metro s = Metro(300), b = Metro(150), e = Metro(500);
...
//  BSP_PB_Init(BUTTON_KEY, BUTTON_MODE_GPIO);
  pinMode(MISSILE,   INPUT); // mandatory for STM MCUs, on Arduino Uno working without
