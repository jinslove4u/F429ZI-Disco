// Arduino Due TFT Library by stimmer
// v0.404 (4/4/2013)
//
//
...
///TFT_F429_Discovery f429LCD;

extern unsigned char _tft_font8x8 [];
...
public:
  int  begin(int x, int y, int m=TFT_MONO);
///  int  beginPAL();
  int  beginNTSC();  
  void end();
